...
val appVersionName = providers.environmentVariable("MEMOS_POCKET_VERSION_NAME").orElse("0.4.1")
...
dependencies {
    ...
    // Test-only real SQLite lifecycle/transaction coverage; production uses the platform helper.
